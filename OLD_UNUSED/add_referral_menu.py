"""
Add referral menu to bot
"""

with open('handlers.py', 'r') as f:
    content = f.read()

print("=== ADDING REFERRAL MENU ===\n")
...
"""
        ...
        for i, ref in enumerate(referrals[-10:], 1):  # Last 10
            username = ref.get('username', 'Unknown')
            joined = ref.get('joined_at', '')[:10]  # YYYY-MM-DD
...
print("✅ Added referral menu functions")
