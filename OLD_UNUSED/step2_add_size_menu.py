...
print("STEP 2: Adding scan_size_menu function\n")

# Funkcja wyboru rozmiaru
new_function = """
...
# Wstaw PRZED handle_scan (około linii 334)
insert_marker = "async def handle_scan(query, user_id, user, scan_type):"

if insert_marker in content:
    content = content.replace(insert_marker, new_function + insert_marker)
    print("✅ Added scan_size_menu before handle_scan")
else:
    print("❌ Could not find handle_scan")
